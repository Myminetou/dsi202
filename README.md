...
**ขั้นตอน:**
- เข้าสู่หน้า **Home**
- กด **สมัครสมาชิก** (หากยังไม่เป็นสมาชิก) หรือ **เข้าสู่ระบบ**
- หากสมัครใหม่:
...
**ขั้นตอน:**
- ที่หน้า **Home** จะมีแถบหมวดหมู่ เช่น:
  - สายสุขภาพ, วิศวกรรม, ภาษา, สถาปัตย์, จิตอาสา, ดิจิทัล-IT
- คลิกหมวดหมู่ที่สนใจ
- ระบบจะแสดงค่ายที่เกี่ยวข้องกับหมวดหมู่นั้น
...
**ขั้นตอน:**
- ไปที่หน้า **Home**
- คลิกที่ **โปรโมทกิจกรรม**
- กรอกข้อมูลเกี่ยวกับค่ายที่ต้องการประชาสัมพันธ์
- กดยืนยัน → ระบบจะรอให้แอดมินตรวจสอบและเผยแพร่
...
- ตรวจสอบว่า Docker Desktop เปิดใช้งานอยู่ก่อนรันคำสั่ง
- หากข้อมูลไม่แสดง ให้ตรวจสอบ `.env`, `settings.py` และ Database migration
- หากต้องการหยุดระบบ กด `Ctrl+C` แล้วใช้:
    ```bash
    docker compose down
    ```
