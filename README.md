...
### 1. จาก User Stories ข้อ 1 - การสมัครสมาชิก / เข้าสู่ระบบ

#### ขั้นตอนการใช้งาน:

1. เมื่อเข้าสู่หน้า **Home** ของ Web Application  
    &nbsp;&nbsp;&nbsp;&nbsp;1.1 กดเข้าไปที่ **สมัครสมาชิก** สำหรับผู้ที่ยังไม่เคยเป็นสมาชิก หรือ **เข้าสู่ระบบ** สำหรับผู้ที่เคยสมัครสมาชิกแล้ว  
    &nbsp;&nbsp;&nbsp;&nbsp;1.2 สำหรับผู้ที่ยังไม่เคยเป็นสมาชิก  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2.1 เมื่อกดเข้าสู่หน้าสมัครสมาชิก ให้ผู้ใช้งานกรอกข้อมูลส่วนตัว หรือ log in ผ่าน Google เพื่อสมัครสมาชิก  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2.2 จากนั้นระบบจะให้กรอกข้อมูล **ระดับชั้น**, **งานอดิเรก**, **ความสนใจ**  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.2.3 เมื่อกรอกข้อมูลเสร็จสิ้น ระบบจะเด้งเข้าสู่หน้า **Profile** และแสดงค่ายที่ตรงกับข้อมูลที่ผู้ใช้งานกรอก  
    &nbsp;&nbsp;&nbsp;&nbsp;1.3 สำหรับผู้ที่เคยสมัครสมาชิกแล้ว  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.1 เมื่อเข้าสู่หน้าเข้าสู่ระบบ ให้ผู้ใช้งานกรอก Email ที่เคยลงทะเบียนไว้ หรือ log in ผ่าน Google  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.2 ระบบจะเด้งเข้าสู่หน้า **Home**  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.3 ให้กดเข้า **Profile** จะแสดงค่ายที่ตรงกับข้อมูลที่ผู้ใช้งานเคยกรอกไว้  
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.3.4 หากต้องการแก้ไขข้อมูล ให้กด **แก้ไขข้อมูล**

---

### 2. จาก User Stories ข้อ 2 - การเลือกหมวดหมู่ค่าย

#### ขั้นตอนการใช้งาน:

1. เมื่อเข้าสู่หน้า **Home**  
    &nbsp;&nbsp;&nbsp;&nbsp;2.1 แถบด้านบนจะแสดงหมวดหมู่ที่มีใน **Peddle Camp** ได้แก่  
    - สายสุขภาพ  
    - สายวิศวกรรม  
    - สายภาษา  
    - สายสถาปัตย์  
    - สายจิตอาสา  
    - สายดิจิทัล ไอที  
    &nbsp;&nbsp;&nbsp;&nbsp;2.2 ผู้ใช้งานสามารถกดเลือกหมวดหมู่ตามที่สนใจ  
    &nbsp;&nbsp;&nbsp;&nbsp;2.3 เมื่อกดเข้าหมวดหมู่ จะแสดงค่ายที่เกี่ยวข้องกับหมวดหมู่นั้นทั้งหมด

---

### 3. จาก User Stories ข้อ 3 - การโปรโมทกิจกรรม

#### ขั้นตอนการใช้งาน:

1. เมื่อเข้าสู่หน้า **Home**  
    &nbsp;&nbsp;&nbsp;&nbsp;3.1 กดเข้าไปที่ **โปรโมทกิจกรรม**  
    &nbsp;&nbsp;&nbsp;&nbsp;3.2 กรอกข้อมูลกิจกรรมหรือค่ายที่ต้องการประชาสัมพันธ์  
    &nbsp;&nbsp;&nbsp;&nbsp;3.3 เมื่อกดยืนยันการเพิ่มค่าย ระบบจะถือว่าเสร็จสิ้น จากนั้นให้รอ Admin มาตรวจสอบ
